...
namespace Tutorial
{
    internal sealed class Program
    {
        ...
        {
            var cw = new DemoComWrappers(true);
    ...
    {
        static readonly IntPtr _iDemoGetTypeVTable;
        static readonly IntPtr _iDemoStoreVTable;
        static readonly ComInterfaceEntry* _demoImplDefinition;
        static readonly int _demoImplDefinitionLen;
        ...
        static DemoComWrappers()
        {
            ...
            //
            {
                ...
                _iDemoGetTypeVTable = (IntPtr)vtable;
            }
            {
                int tableCount = 4;
                int idx = 0;
                ...
                Debug.Assert(tableCount == idx);
                _iDemoStoreVTable = (IntPtr)vtable;
            }
            ...
            //
            {
                _demoImplDefinitionLen = 2;
                int idx = 0;
                var entries = (ComInterfaceEntry*)RuntimeHelpers.AllocateTypeAssociatedMemory(
                    typeof(DemoComWrappers),
                    sizeof(ComInterfaceEntry) * _demoImplDefinitionLen);
                entries[idx].IID = IDemoGetType.IID_IDemoGetType;
                entries[idx++].Vtable = _iDemoGetTypeVTable;
                entries[idx].IID = IDemoStoreType.IID_IDemoStoreType;
                entries[idx++].Vtable = _iDemoStoreVTable;
                Debug.Assert(_demoImplDefinitionLen == idx);
                _demoImplDefinition = entries;
            }
        }
        ...
        protected override unsafe ComInterfaceEntry* ComputeVtables(object obj, CreateComInterfaceFlags flags, out int count)
        {
            ...
            if (obj is DemoImpl)
            {
                count = _demoImplDefinitionLen;
                return _demoImplDefinition;
            }
