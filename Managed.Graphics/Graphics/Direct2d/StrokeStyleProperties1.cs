// <copyright file="StrokeStyleProperties1.cs" company="Dmitry Kolchev">
...
public unsafe struct StrokeStyleProperties1
{
    ...
    public StrokeStyleProperties1(CapStyle startCap, CapStyle endCap, CapStyle dashCap,
    ...
    internal StrokeStyleProperties1(in D2D1_STROKE_STYLE_PROPERTIES1 properties)
    {
        ...
        TransformType = (StrokeTransformType)properties.transformType;
    }
}
